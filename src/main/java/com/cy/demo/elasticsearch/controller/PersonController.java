...
import com.cy.demo.elasticsearch.service.PersonService;
...
//        }
     ...
     *
     ...
     sort可以用来排序
     */
    @GetMapping("/query/{lat}/{lon}")
    public Object query(@PathVariable double lat, @PathVariable double lon) {
